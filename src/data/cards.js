export const cards = [ 
  ['Action (set A)', 'Action (set B)', 'Animal (set A)', 'Animal (set B)', 'Clothes', 'Emotions', 'Food', 'Transport'],
  [
    {
      word: 'cry',
      translation: 'плакать',
...
export const modules = [
  ...
  {
      module: 'Food',
      image: './data/img/food.png'
  },
  {
      module: 'Transport',
      image: './data/img/car.png'
  },
];